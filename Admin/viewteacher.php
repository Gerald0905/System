		...
		<form method="post">
			<table class="table1">
				<tr>
					...
					<td colspan="4" align="right">
						<div class="delete-teacher">
							<a href="deleteTeacherInfo.php?tid=<?php echo $rec['teacher_ID']; ?>" onclick="confirm('Are you sure to delete this record with its account?');">Delete Record</a>
						</div>
					</td>
				</tr>
				<tr>
				...
				<td class="head">Last Name</td>
						<td><input type="text" class="adviser_list" name="teacher_lname" value="<?php echo $rec['teacher_lname']; ?>" placeholder="" required></td>
                        <td class="head">First Name</td>
                        <td><input type="text" class="adviser_list" name="teacher_fname" value="<?php echo $rec['teacher_fname']; ?>" placeholder="" required></td>
                        <td class="head">Middle Name</td>
                        <td><input type="text" class="adviser_list" name="teacher_mname" value="<?php echo $rec['teacher_mname']; ?>" placeholder="" required></td>
				</tr>
				<tr>
			...
			<?php
				if(isset($_REQUEST['update'])){
					...
					$up = mysqli_query($conn, "UPDATE tbl_teacher SET teacher_lname = '$teacher_lname', teacher_fname = '$teacher_fname', teacher_mname = '$teacher_mname', teacher_email_address = '$teacher_email_address', teacher_sex = '$teacher_sex', teacher_bday = '$teacher_bday', section_name = '$section_name', teacher_address = '$teacher_address', teacher_contact_number = '$teacher_contact_number', strands_name = '$strands_name', subject_teaching = '$subject_teaching', teacher_status = '$teacher_status' WHERE teacher_ID = '$tid'");
					$up1 = mysqli_query($conn, "UPDATE tbl_teacheraccount SET teacher_email_address = '$teacher_email_address' WHERE teacher_ID = '$tid'");
