...
<body>
	...
	<div class="container">
		<form method="post">
			...
			<div class="content">
				<table>
					...
					<tr>
						...
						<td class="head" align="center">First Quarter Grade</td>
							...
							<div class="btn3">
								<?php 
									if( $list1['first_grade']){
										...
										<div class="btn3-add">
											<a  id="add" href="add.php?esid=<?php echo $list1['es_ID']; ?>">Add Grade</a>
										<div>
									<?php }	
								?>
			...
			<a class="secQuarter" href="addinggrades1.php?esid=<?php echo $subjectsQryRec['es_ID']; ?>">Second Quarter<i class="fas fa-chevron-circle-right"></i></a>
		</div>
