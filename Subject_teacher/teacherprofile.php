...
session_start();
$tid = $_SESSION['stid'];
$sql = mysqli_query($conn, "SELECT * FROM tbl_subjectteacher as t1 inner join tbl_strands as t2 on t1.strands_name = t2.strands_name WHERE t1.teacher_ID = '$tid'");
$sql1 = mysqli_query($conn, "SELECT * FROM tbl_subjectteacher as t1 inner join tbl_subteacheraccount as t2 on t1.teacher_ID = t2.subteacher_ID WHERE t1.teacher_ID = '$tid'");
