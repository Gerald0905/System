...
session_start();
$stid = $_SESSION['stid'];
$sql = mysqli_query($conn, "SELECT * FROM tbl_subjectteacher as t1 inner join tbl_strands as t2 on t1.strands_name = t2.strands_name WHERE t1.teacher_ID = '$stid'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class='view' ><h1>Hi, <?php echo $list['teacher_fname'] .' ' .$list['teacher_lname'];?>!</h1></div>
            <div class="hero__text">  
                ...
                <a href="teacheradvisees.php" class="btn">My Subject Advisees</a>
            </div>
        </div>
