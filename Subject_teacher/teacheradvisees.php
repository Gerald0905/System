...
<body>
	...
	if($sql1Result == 0){	?>
		<script>
			alert("You have no current students registered for this subject. For any concern, please refer to the system administrator.");
			window.location = "subteacherdashboard.php";
		</script> <?php 
		}
	elseif($sql1Result != 0){	?>
		<div class="container">
		...
		<div class="content">
			...
			elseif ($studentCountResult['num'] == 0){ ?>
				<input type="submit" name="uploadFirstGrade" class="submitGrade" value="Upload Grade" onclick="alert('Are you sure?')">
			<?php }
			?>
			</form>
		</div>
