	...
	<form method="post" action="../login.php">
		<div class="container">
			...
			<div class="header-label">
				<h5><marquee direction="left" scrollamount="7">Login Form for Teachers</marquee></h5>
			</div>
			<div class="form-floating mb-3">
			  <input type="text" name="teacher_username" required class="form-control" id="floatingInput" placeholder="username">
			  <label for="floatingInput">Adviser Teacher's Username</label>
			</div>
			...
			<div class="btn">
				<input type="submit" name="teacherSubmit" value="Login">
			...
			<hr>
			<div class="dir">
				<label for="not">Not a Adviser? Log in as</label>
				<a href="studentLogin.php" name="not">Student</a> <label>or </label><a href="subteacherlogin.php" name="not">Subject Teacher</a><label>or </label>
