...
$sql1 = mysqli_query($conn, "SELECT * FROM tbl_student as t1 inner join tbl_enrolledsubjects as t2 on t1.stud_lrn = t2.stud_lrn WHERE t1.stud_ID = '$sid' AND t2.yearlevel = 'GRADE 12' AND t2.semester = 'FIRST'");
$sql2 = mysqli_query($conn, "SELECT * FROM tbl_student as t1 inner join tbl_enrolledsubjects as t2 on t1.stud_lrn = t2.stud_lrn WHERE t1.stud_ID = '$sid' AND t2.yearlevel = 'GRADE 12' AND t2.semester = 'FIRST'");
$rec = mysqli_fetch_assoc($sql2);

$sql3 = mysqli_query($conn, "SELECT COUNT(*) as num FROM tbl_enrolledsubjects WHERE stud_ID = '$sid' AND yearlevel = 'GRADE 12' AND semester = 'FIRST' AND second_grade != '0'");
...
<html>
<head>
	<title>Grade 12 | Second Grading</title>
	<meta charset="utf-8">
...
<?php
	...
	<div class="container">
		<form method="post">
			...
			<div class="content">
				<table>
					...
					<td align="left" colspan="6">
							...
							<label> | </label>
							<a href="####" class="active">Grade 12 - First Semester</a>
							<label> | </label>
							<a href="addinggrades6.php?sid=<?php echo $list['stud_ID']; ?>" class="nonactive">Grade 12 - Second Semester</a>
						</td>
					</tr>
					<?php } 
					?>
					...
					<tr class="content">
						...
						<td align="center">
							...
							<input type="hidden" class="lrn" name="first_grade" readonly value="<?php echo $list1['second_grade']; ?>">
						</td>
						<td align="center">
						<div class="btn3">
								<?php 
									if( $list1['second_grade']){
										...
										<div class="btn3-add">
											<a  id="add" href="add5.php?esid=<?php echo $list1['es_ID']; ?>">Add Grade</a>
										<div>
									<?php }	
								?>
								...
								if(isset($_POST['calc'])){
									if ($count['num'] > 0) {
										...
										<script type="text/javascript">
											...
											window.location = "addinggrades5.php?sid=<?php echo $rec['stud_ID']; ?>";
										</script>	<?php
									}
			...
			<a class="secQuarter" href="addinggrades4.php?sid=<?php echo $rec['stud_ID']; ?>"><i class="fas fa-chevron-circle-left"></i>First Quarter</a>
		</div>
