...
$sql3 = mysqli_query($conn, "SELECT COUNT(*) as num FROM tbl_enrolledsubjects WHERE stud_ID = '$sid' AND yearlevel = 'GRADE 12' AND semester = 'FIRST' AND first_grade != '0'");
...
<html>
<head>
	<title>Grade 12 | First Quarter</title>
	<meta charset="utf-8">
...
<?php
	...
	<div class="container">
		<form method="post">
							...
							<div class="btn3">
								<?php 
									if( $list1['first_grade']){
										...
										<div class="btn3-add">
											<a  id="add" href="add4.php?esid=<?php echo $list1['es_ID']; ?>">Add Grade</a>
										<div>
									<?php }	
								?>
			...
			<a class="secQuarter" href="addinggrades5.php?sid=<?php echo $rec['stud_ID']; ?>">Second Quarter<i class="fas fa-chevron-circle-right"></i></a>
		</div>
