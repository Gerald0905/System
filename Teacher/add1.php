						...
						<td align="center">
							...
							<?php
								if (isset($_POST['submit'])) {
									...
									$insertGrade = mysqli_query($conn, "UPDATE tbl_enrolledsubjects SET second_grade = '$grade' WHERE es_ID = '$es_ID'");
									...
									if($insertGrade){	?>
										<script type="text/javascript">
											...
											window.location = "addinggrades1.php?esid=<?php echo $rec['es_ID']; ?>";
										</script>	
