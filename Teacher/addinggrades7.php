...
$sql3 = mysqli_query($conn, "SELECT COUNT(*) as num FROM tbl_enrolledsubjects WHERE stud_ID = '$sid' AND yearlevel = 'GRADE 12' AND semester = 'SECOND' AND second_grade != '0'");
...
<?php
	...
	<div class="container">
		<form method="post">
						...
						<div class="btn3">
								<?php 
									if( $list1['second_grade']){
										...
										<div class="btn3-add">
											<a  id="add" href="add7.php?esid=<?php echo $list1['es_ID']; ?>">Add Grade</a>
										<div>
									<?php }	
								?>
								...
								if(isset($_POST['calc'])){
									if ($count['num'] > 0) {
										...
										<script type="text/javascript">
											...
											window.location = "addinggrades7.php?sid=<?php echo $rec['stud_ID']; ?>";
										</script>	<?php
									}
			...
			<a class="secQuarter" href="addinggrades6.php?sid=<?php echo $rec['stud_ID']; ?>"><i class="fas fa-chevron-circle-left"></i>Third Quarter</a>
		</div>
