...
$sql3 = mysqli_query($conn, "SELECT COUNT(*) as num FROM tbl_enrolledsubjects WHERE stud_ID = '$sid' AND yearlevel = 'GRADE 11' AND semester = 'SECOND' AND first_grade != '0'");
...
<html>
<head>
	<title>Grade 11 | Third Grading</title>
	<meta charset="utf-8">
...
<?php
	...
	<div class="container">
		<form method="post">
					...
					<tr class="content">
						...
						<td align="center">
							...
							<?php 
									...
									<div class="btn3-add">
										<a  id="add" href="add2.php?esid=<?php echo $list1['es_ID']; ?>">Add Grade</a>
									</div>
									<?php }	
								?>
								...
								if(isset($_POST['calc'])){
									if ($count['num'] > 0) {
										...
										<script type="text/javascript">
											...
											window.location = "addinggrades2.php?sid=<?php echo $rec['stud_ID']; ?>";
										</script>	<?php
									}
			...
			<a class="secQuarter" href="addinggrades3.php?sid=<?php echo $rec['stud_ID']; ?>">Fourth Quarter<i class="fas fa-chevron-circle-right"></i></a>
		</div>
