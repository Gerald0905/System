...
$sql1 = mysqli_query($conn, "SELECT * FROM tbl_student as t1 inner join tbl_enrolledsubjects as t2 on t1.stud_lrn = t2.stud_lrn WHERE t1.stud_ID = '$sid' AND t2.yearlevel = 'GRADE 11' AND t2.semester = 'SECOND'");
...
$sql3 = mysqli_query($conn, "SELECT COUNT(*) as num FROM tbl_enrolledsubjects WHERE stud_ID = '$sid' AND yearlevel = 'GRADE 11' AND semester = 'SECOND' AND second_grade != '0'");
...
<html>
<head>
	<title>Grade 11 | Fourth Grading</title>
	<meta charset="utf-8">
...
<?php
	...
	<div class="container">
		<form method="post">
			...
			<div class="content">
				<table>
					...
					<td align="left" colspan="6">
							...
							<label> | </label>
							<a href="" class="active">Grade 11 - Second Semester</a>
							<label> | </label>
					...
					<tr>
						...
						<td class="head" align="center">Fourth Grading Mark</td>
						...
						<div class="btn3">
								<?php 
									if( $list1['second_grade']){
										...
										<div class="btn3-add">
											<a  id="add" href="add3.php?esid=<?php echo $list1['es_ID']; ?>">Add Grade</a>
										<div>
									<?php }	
								?>
								...
								if(isset($_POST['calc'])){
									if ($count['num'] > 0) {
										...
										<script type="text/javascript">
											...
											window.location = "addinggrades3.php?sid=<?php echo $rec['stud_ID']; ?>";
										</script>	<?php
									}
			...
			<a class="secQuarter" href="addinggrades2.php?sid=<?php echo $rec['stud_ID']; ?>"><i class="fas fa-chevron-circle-left"></i>Third Quarter</a>
		</div>
