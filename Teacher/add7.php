	...
	<div class="container">
		...
		<div class="content">
			<form method="post">
						...
						<td align="center">
							...
							<?php
								if (isset($_POST['submit'])) {
									...
									$insertGrade = mysqli_query($conn, "UPDATE tbl_enrolledsubjects SET second_grade = '$grade' WHERE stud_ID = '$stud_ID' AND stud_lrn = '$stud_lrn' AND es_ID = '$es_ID'");
				...
				<div class="footer">
					<a href="addinggrades7.php?sid=<?php echo $rec['stud_ID']; ?>"><i class="fas fa-chevron-circle-left"></i>Go back</a>
				</div>
			</form>
