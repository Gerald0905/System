	...
	elseif($studentCountQryResult['num'] == $studentCountQryResult1['num']){	?>
		...
		<div class="content">
					...
					<tr>
						...
						<td colspan="6" align="right">
							<div class="to-2nd-Q">
								...
								<a href="teacheradvisees.php?tid=<?php echo $tid; ?>">Go to 
								<?php 
								if($sql1Result['semester'] == 'First'){
									echo 'First';
								}
			...
			elseif ($studentCountResult['num'] == 0){ ?>
				<input type="submit" name="uploadSecondGrade1" class="submitGrade" value="Upload Grade" onclick="alert('Are you sure?')">
			<?php }
			?>
			</form>
		</div>
